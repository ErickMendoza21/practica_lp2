...
public class CarreraController {
	...
	@PostMapping("/carrera")
	  public ResponseEntity<CarreraEntity> createTutorial(@RequestBody CarreraEntity carre) {
	    try {
	      CarreraEntity carre = carreraService.create(new CarreraEntity(carre.getId(), carre.getNombre(), carre.getEstado()));
	...
	@PutMapping("/carre/{id}")
	  public ResponseEntity<CarreraEntity> updateTutorial(@PathVariable("id") long id, @RequestBody CarreraEntity carre) {
	    ...
	    if (carrera!=null) {
	    	carrera.setId(carre.getId());
	    	carrera.setNombre(carre.getNombre());
	    	carrera.setEstado(carre.getEstado());
